    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 caption mt-60">
                <div class="subtitle">Galería</div>
                <div class="title">Checa nuestra galería</div>
            </div>
        </div>
    </div>
</div>
     ...
     <div class="container">
         ...
         <div class="row text-center animate-box" data-animate-effect="fadeInUp">
             <ul class="projects2-filter">
                 ...
                 <li data-filter=".ongoing">Corredera</li>
                 <li data-filter=".completed">Pivotante</li>
                 <li data-filter=".completed">Guillotina</li>
                 <li data-filter=".completed">Turnable Corner</li>
             </ul>
         </div>
