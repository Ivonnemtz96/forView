...
<section class="project-page section-padding" style="padding-bottom: 0px;">
    <div class="container-fluid p-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="fotorama" data-width="100%" data-ratio="800/600" data-minwidth="400" data-maxwidth="1000" data-minheight="300" data-maxheight="100%" data-loop="true">
                ...
                <li class="accordion block <? echo $var54_1; ?>">
                    ...
                    <div class="acc-content" style="<? echo $var54_3; ?>;">
                        <div class="content">
                            ...
                            <a type="button" class="btn btn-dark mt-3" href="/pdf/Integrado-FV54.pdf" download="Integrado-FV54.pdf">
                                Descargar hoja de datos <i class="ti-arrow-circle-down"></i>
                            </a>
                        </div>
                    </div>
