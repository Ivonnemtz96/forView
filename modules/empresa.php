<!-- Header Banner -->
<div class="banner-header valign bg-img bg-fixed" data-background="/images/slider/12.jpg"
    style="background-position: bottom center;">
    <div hidden class="container-fluid">
        <div class="row">
            <div class="col-md-12 caption mt-60">
                <div style="background-color: #fff;color:#000; margin-left: -1rem; margin-right: -2rem;" class="title">
                    <div class="container">
                        <h3 style="background-color: #fff; margin-left: 0;" class="subtitle">
                            Nuestra empresa </h3>
