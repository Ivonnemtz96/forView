        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInUp">
                ...
                <p>
                    ...
                    <br><br>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Adipisci sequi exercitationem facilis cum
                    quia aperiam aspernatur voluptatum eius ratione ipsa! In autem vel recusandae ut laudantium aperiam,
                    error est nisi ad facere illum libero numquam porro minus, modi officia praesentium!
                </p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-30">
                    <h3 class="sub-title border-bot-dark" style="color: #000;"><strong>Opiniones</strong></h3>
                </div>
                <div class="col-md-8">
