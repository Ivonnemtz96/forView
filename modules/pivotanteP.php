        ...
        <li class="accordion block <? echo $var28_1;?>">
          ...
          <div class="acc-content" style="<? echo $var28_3;?>;">
            <div class="content">
              ...
              <a type="button" class="btn btn-dark mt-3" href="/pdf/Pivotante-FV28.pdf" download="Pivotante-FV28.pdf">
        ...
        <li class="accordion block <? echo $var38_1;?>">
          ...
          <div class="acc-content" style="<? echo $var38_3;?>;">
            <div class="content">
              ...
              <a type="button" class="btn btn-dark mt-3" href="/pdf/Pivotante-FV38.pdf" download="Pivotante-FV38.pdf">
                Descargar hoja de datos <i class="ti-arrow-circle-down"></i>
              </a>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row mb-5 animate-box" data-animate-effect="fadeInUp">
      ...
      <div class="col-md-6">
        ...
        <a type="button" class="btn btn-dark mt-3" href="/pdf/Pivotante.pdf" download="Pivotante.pdf">
          Descargar
        </a>
      </div>
    </div>
