...
<section class="project-page section-padding">
    <div class="container-fluid p-5">
        <div class="row align-items-center">
            <div class="col-md-6">
                <span>Producto</span>
                <h2>Turnable Corner</h2>
                <h2></h2>
                <p>
                    El innovador sistema Turnable Corner ha sido diseñado para maximizar la eficiencia del espacio,
                    empleando un ingenioso sistema de rodamientos que permiten pivotar y deslizar los elementos
                    acristalados con facilidad. Gracias a esta solución arquitectónica de vanguardia, se consigue
                    liberar completamente el acceso a los elementos acristalados, tanto en el frente como en las
                    esquinas, lo que representa una importante mejora en términos de funcionalidad y comodidad.
                </p><br>
            ...
            <div class="col-md-6">
                <div class="fotorama" data-width="100%" data-ratio="800/600" data-minwidth="400" data-maxwidth="1000"
                    ...
                    <img class="img-fluid" src="/images/slider/turnable.jpg" alt="">
                    <img class="img-fluid" src="/images/slider/turnable2.jpg" alt="">
                    <img class="img-fluid" src="/images/slider/turnable3.jpg" alt="">
                    <img class="img-fluid" src="/images/slider/turnable4.jpg" alt="">
