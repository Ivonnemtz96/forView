        ...
        <li class="accordion block <? echo $var17_1;?>">
          ...
          <div class="acc-content" style="<? echo $var17_3;?>;">
            <div class="content">
              ...
              <a type="button" class="btn btn-dark mt-3" href="/pdf/Clásica-FV 17.pdf" download="Clásica-FV 17.pdf">
        ...
        <li class="accordion block <? echo $var38_1;?>">
          ...
          <div class="acc-content" style="<? echo $var38_3;?>;">
            <div class="content">
              ...
              <a type="button" class="btn btn-dark mt-3" href="/pdf/Clásica-FV38.pdf" download="Clásica-FV38.pdf">
                Descargar hoja de datos <i class="ti-arrow-circle-down"></i>
              </a>
            </div>
          </div>
        ...
        <li class="accordion block <? echo $var54_1;?>">
          ...
          <div class="acc-content" style="<? echo $var54_3;?>;">
            <div class="content">
              ...
              <a type="button" class="btn btn-dark mt-3" href="/pdf/Clásica-FV54.pdf" download="Clásica-FV54.pdf">
                Descargar hoja de datos <i class="ti-arrow-circle-down"></i>
              </a>
            </div>
          </div>
        ...
        <li class="accordion block <? echo $var1_1;?>">
          ...
          <div class="acc-content" style="<? echo $var1_3;?>;">
            <div class="content">
              ...
              <a type="button" class="btn btn-dark mt-3" href="/pdf/Clásica-Esencia.pdf" download="Clásica-Esencia.pdf">
                Descargar hoja de datos <i class="ti-arrow-circle-down"></i>
              </a>
            </div>
          </div>
